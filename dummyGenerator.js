module.exports = function() {
  ...
  nameArr = ["Erik Johansson", "Anna Andresson", "Karl Karlsson", "Elisabeth Nilsson", "Nils Olsson", "Birgitta Olsson", "Peter Hansson", "Sofia Hansson", "Elin Axelsson", "Johanna Lindström"," Åke Lindström", "Bo Lindberg", "Fredrik Carlsson", "Ingrid Petterson", "Mikael Svensson", "Markus Hellström", "Maja Linsson", "Anders Andersson", "Per Åkesson"," Malin Svensson", "Gullbritt Eliasson", "Johan Folk", "Andre Persson", "Alex Vikström", "Petter Andreasson", "Linus Petterson", "Jessica Månsson", "Noah Eliasson", "Molly Sanden", "Melissa Jönsson", "Simon Eriksson", "Helena Olofsson", "Cecilia Lindgren", "Bo Magnusson", "Daniel Carlsson", "Carl Helgasson", "Malin Olofsson", "Andreas Pålsson", "Olof Jonsson", "Felicia Andresson", "Henrik Stålhammar", "Benjamin Nilsson", "Elvira Eliasson", "Nils Gullberg", "Petra Pettersson", "Alice Persson", "Linda Månsson", "Paul Tobiasson"]
  numberArr = ["(995) 605-1549","(981) 652-5696", "(563) 146-7238","(948) 282-2787","(780) 892-7822", "(789) 868-3333", "(542) 853-3342", "(474) 101-1910","(179) 823-6679","(100) 227-8412","(729) 722-0811","(368) 947-5456", "(458) 315-9824", "(682) 424-0051", "(377) 974-0592", "(548) 708-4299", "(289) 915-5991", "(769) 854-1567","(138) 743-2271", "(371) 198-5115", "(776) 763-1869", "(513) 986-3565"];
  ...
  console.log("pris:",priceArr.length)
  console.log("semester:",semesterArr.length)
  console.log("name:",nameArr.length)
  console.log("number:",numberArr.length)
  console.log("reg:",regArr.length)
  console.log("status:",statusArr.length)
  console.log("reserv:",reservArr.length)
  console.log("beskr:",beskrArr.length)
...
//console.log("ett NAMNNNNNNNN:   ", [Math.floor(Math.random()*47)])

    var enAnstalld = new m.modelsanstallda({
      namn: nameArr[Math.floor(Math.random()*nameArr.length)],
    ...
    enAnstalld.save(function(err){
      ...
      var enKund = new m.modelskunder({
        namn: nameArr[Math.floor(Math.random()*nameArr.length)],
        tfn: numberArr[Math.floor(Math.random()*numberArr.length)]
      }) 
      enKund.save(function(err){
        ...
        var enSkada = new m.modelsskador({
          ...
          beskr: beskrArr[Math.floor(Math.random()*beskrArr.length)],
          antalTim: Math.floor(Math.random()*6),
        ...
        enSkada.save(function(err){
          ...
          var enReserv = new m.modelsreservdelar({
            namn: reservArr[Math.floor(Math.random()*reservArr.length)],
            pris: priceArr[Math.floor(Math.random()*priceArr.length)],
            skada: enSkada._id
          })
          enReserv.save(function(err){
            ...
            var enBil = m.modelsbilar({
              model: modelArr[Math.floor(Math.random()*modelArr.length)],
              regnum: regArr[Math.floor(Math.random()*regArr.length)],
              kund: enKund._id,
              skada: enSkada._id,
            })
